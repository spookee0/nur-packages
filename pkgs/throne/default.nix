{
  ...
  protorpc = buildGoModule (finalAttrs: {
    pname = "protorpc";
    version = "1.1.2";
  ...
  srslist_h = fetchurl {
    url = "https://github.com/throneproj/routeprofiles/raw/refs/heads/rule-set/srslist.h";
    sha256 = "sha256-OUxGMSidxduQ2UM4nF0OrPGZvZJiSCg9xRaTruKFaTs=";
  };
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-2XQ/rHE8BwLGfuDzgP0MwS6NsEql6eOdc+PTS6y5kzA=";
    };
    ...
    postPatch = ''
      # Copy the downloaded header into the expected location

      cp ${srslist_h} /build/source/srslist.h
      ls -la /build
    '';
